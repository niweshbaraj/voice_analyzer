    ...
    <div>
            ...
            <main>
                <div>
                    ...
                    <button type="button" className="bg-red-400 text-white p-3 rounded-md uppercase hover:opacity-95 disable:opacity-80" onClick={stopRecording}>
                        Stop Recording
                    </button>
                    </span>
                    ) : null}
                    ...
                    <div>
                        ...
                        <p onClick={transcribe}>Transcribe</p>
                    </div>
                    ) : null}
                    ...
                    <p className="font-normal text-gray-700 dark:text-gray-400">{transcription}</p>
                    </div>
